...
export class DefaultApi extends runtime.BaseAPI {
     ...
     * ブックのツリー情報取得
     */
    async apiV2BookBookIdTreeGetRaw(requestParameters: ApiV2BookBookIdTreeGetRequest): Promise<runtime.ApiResponse<InlineResponse2008>> {
        if (requestParameters.bookId === null || requestParameters.bookId === undefined) {
     ...
     * ブックのツリー情報取得
     */
    async apiV2BookBookIdTreeGet(requestParameters: ApiV2BookBookIdTreeGetRequest): Promise<InlineResponse2008> {
